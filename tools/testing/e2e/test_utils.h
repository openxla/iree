#ifndef IREE_TESTING_COMMON_UTILS_H_
#define IREE_TESTING_COMMON_UTILS_H_
...
iree_e2e_test_value_t iree_e2e_test_value_make_none();

iree_e2e_test_value_t iree_e2e_test_value_make_i8(int8_t value);

iree_e2e_test_value_t iree_e2e_test_value_make_i16(int16_t value);

iree_e2e_test_value_t iree_e2e_test_value_make_i32(int32_t value);

iree_e2e_test_value_t iree_e2e_test_value_make_f16(uint16_t value);

iree_e2e_test_value_t iree_e2e_test_value_make_bf16(uint16_t value);

iree_e2e_test_value_t iree_e2e_test_value_make_f32(float value);
...
iree_status_t load_and_run_e2e_tests(
    ...
    iree_status_t (*test_module_create)(iree_vm_instance_t*, iree_allocator_t,
                                        iree_vm_module_t**));
#endif  // IREE_TESTING_COMMON_UTILS_H_
