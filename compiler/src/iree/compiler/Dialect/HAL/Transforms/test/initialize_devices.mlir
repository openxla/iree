...
//      CHECK:   util.status.check_ok %c5_i32, "HAL device `device_123` not found: #hal.device.ordinal<123>"
...
// CHECK-NEXT: scf.if %[[IS_NULL]] {
//      CHECK:   util.status.check_ok %c5_i32, "HAL device `device_fallback` not found: #hal.device.fallback<@device_base>"
...
// CHECK-NEXT: scf.if %[[IS_NULL]] {
//      CHECK:   util.status.check_ok %c5_i32, "HAL device `device_a` not found: #hal.device.target<{{.+}}>"
...
// CHECK-NEXT: scf.if %[[IS_NULL]] {
//      CHECK:   util.status.check_ok %c5_i32, "HAL device `selected` not found: #hal.device.select<{{.+}}>"
