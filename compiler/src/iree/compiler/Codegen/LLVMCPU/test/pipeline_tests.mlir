...
#map1 = affine_map<(d0, d1) -> (d0, d1)>
module {
  func.func @quant_matmul_fusion() attributes {hal.executable.target = #executable_target_embedded_elf_x86_64_} {
    %c0 = arith.constant 0 : index
    ...
    %17 = linalg.generic {indexing_maps = [#map, #map1, #map, #map, #map, #map1], iterator_types = ["parallel", "parallel"]} ins(%9, %16, %10, %11, %12 : tensor<144xi32>, tensor<2304x144xi32>, tensor<144xi32>, tensor<144xi32>, tensor<144xi8>) outs(%13 : tensor<2304x144xi8>) {
