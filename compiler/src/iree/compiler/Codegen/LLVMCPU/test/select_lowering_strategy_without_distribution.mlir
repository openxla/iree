// RUN: iree-opt --pass-pipeline='builtin.module(func.func(iree-llvmcpu-select-lowering-strategy))' --iree-llvmcpu-disable-distribution --split-input-file %s | FileCheck %s
